...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    var necessaryModules = ['moment', 'jquery'];
  ...
  $.fn.timezoneMapper = function(options) {
    ...
    var $map = this.find(options.map);;
    var $labelName = this.find(options.labelName);
    var $labelTime = this.find(options.labelTime);
    var $axisX = this.find(options.axisX);
    var $axisY = this.find(options.axisY);
